...
Window IVSCCControlPanel() : Panel
	...
	NewPanel/K=1 /W=(377,154,668,345) as "IVSCC control panel"
	SetDrawLayer UserBack
	Button button_ivs_setup,pos={86.00,19.00},size={130.00,30.00},proc=IVS_ButtonProc_Setup,title="Setup DAEphys panel"
	Button button_runGigOhmSealQC,pos={55.00,132.00},size={190.00,30.00},title="Run GΩ seal check"
	Button button_runBaselineQC,pos={53.00,63.00},size={190.00,30.00},title="Run baseline QC"
	Button button_runAccessResisQC,pos={54.00,98.00},size={190.00,30.00},title="Run access resistance QC check"
EndMacro
